    ...
    <article className="mx-4 mt-10 grid grid-cols-1 grid-rows-[1fr_0.5fr_1fr] gap-8 sm:mx-auto sm:w-2/3 lg:grid-cols-2 lg:grid-rows-[1fr,_0.75fr]">
      ...
      <div className="col-span-1 row-span-1 font-sans lg:row-span-2">
        ...
        <p className="mt-2 h-min text-justify">
          ...
          officiis modi, suscipit ipsa. Lorem ipsum dolor sit amet consectetur
          adipisicing elit. Ipsum vel magni ullam id. Ad, rerum facilis? Ipsa,
          commodi sunt. Fugit possimus ad dolorum eveniet cupiditate,
          consectetur itaque repellat voluptatum quam aperiam aliquam molestiae
          officiis qui adipisci ex est error enim?
        </p>
      </div>
      <div>
        <Link href="/">
